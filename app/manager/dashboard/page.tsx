          ...
          >
            <div>
              <div className="flex lg:flex-1">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Welcome, Manager!</h2>
              ...
              <PopoverGroup className="flex flex-col gap-y-4 mt-6">
                ...
                <Link href="/Components/Purchase" className="text-sm/6 font-semibold text-gray-900 hover:bg-gray-100">
                  Purchases
                </Link>
                <Link href="/Components/Contacts" className="text-sm/6 font-semibold text-gray-900 hover:bg-gray-100">
                  Contacts
                </Link>
                <Link href="/Components/Productsetting" className="text-sm/6 font-semibold text-gray-900 hover:bg-gray-100">
                  Product Setting
                </Link>
                <Link href="/Components/Report" className="text-sm/6 font-semibold text-gray-900 hover:bg-gray-100">
                  Report
                </Link>
