    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-4xl bg-white p-8 rounded-lg shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Without Bar-code */}
          <div>
            <label className="block text-sm font-medium text-gray-700">Without Bar-code</label>
            <input
              type="text"
              name="withoutBarcode"
          ...
          {/* Receivable by Cash */}
          <div>
            <label className="block text-sm font-medium text-gray-700">Receivable by Cash</label>
            <input
              type="number"
          ...
          {/* Receivable by Bank */}
          <div>
            <label className="block text-sm font-medium text-gray-700">Receivable by Bank</label>
            <input
              type="number"
          ...
          {formData.selectOption === "Mobile Banking" && (
            <div>
              <label className="block text-sm font-medium text-gray-700">Mobile Banking</label>
              <select
                name="mobileBanking"
                value={formData.bankName}
                onChange={handleChange}
          ...
          {/* Receivable */}
          <div>
            <label className="block text-sm font-medium text-gray-700">Receivable</label>
            <input
              type="number"
              name="receivable"
